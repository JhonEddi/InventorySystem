...
insert into usuario values (1075685670, 'Malagon', 23, '02/20/2021', 'Jhon', 2);
...
insert into usuario values (1111111111, 'Prueba6', 20, '02/14/2021', 'Usuario6', 3);

--Llenado Tabla Mercancia
--Mercancia para Usuario 1(Jhon)
insert into mercancia values ('Mercancia1', 12, '03/21/2021', 1075685670);
insert into mercancia values ('Mercancia2', 23, '04/22/2021', 1075685670);
insert into mercancia values ('Mercancia3', 45, '05/23/2021', 1075685670);
...
insert into mercancia values ('Mercancia16', 25, '06/21/2021', 1111111111);
insert into mercancia values ('Mercancia17', 10, '07/22/2021', 1111111111);
insert into mercancia values ('Mercancia18', 11, '08/05/2021', 1111111111);
